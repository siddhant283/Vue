        ...
        <form @submit="submitDetails">
          ...
          <div class="form-group">
            ...
            <div v-if="$v.model.firstname.$dirty || submitted">
              <p
                v-if="!$v.model.firstname.required"
                class="text-danger"
              >
                First Name is required
              </p>
              <p
                v-if="!$v.model.firstname.minLength"
                class="text-danger"
              >
          ...
          <div class="form-group">
            ...
            <div v-if="$v.model.lastname.$dirty || submitted">
              ...
              <p
                v-if="!$v.model.lastname.minLength"
                class="text-danger"
              >
          ...
          <div class="form-group">
            ...
            <div v-if="$v.model.phone.$dirty || submitted">
              <p
                v-if="!$v.model.phone.required"
                class="text-danger"
              >
                Phone Number is required.
              </p>
              <p
                v-if="!$v.model.phone.minLength"
                class="text-danger"
              >
              ...
              <p
                v-if="!$v.model.phone.digits"
                class="text-danger"
              >
                Phone can only contain digits.
              </p>
              <p
                v-if="alreadyRegisteredPhone"
                class="text-danger"
              >
...
export default {
  ...
  methods: {
    submitDetails(e) {
      ...
      setTimeout(() => {
        const user = this.model.firstname;
