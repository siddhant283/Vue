        ...
        <form @submit="registerUser">
          ...
          <div class="form-group">
            ...
            <div v-if="$v.model.username.$dirty || submitted">
              <p class="text-danger" v-if="!$v.model.username.required">
                this field is required
              </p>
              <p class="text-danger" v-if="!$v.model.username.minLength">
                Username must have at least
                {{ $v.model.username.$params.minLength.min }} characters.
              </p>
              <p class="text-danger" v-if="!$v.model.username.alpha">
                UserName can only contain AlphaNumeric Characters and Special
                Characters (*,_,@,.)
              </p>
              <p class="text-danger" v-if="alreadyRegisteredUsername">
          ...
          <div class="form-group">
            ...
            <div v-if="$v.model.email.$dirty || submitted">
              <p class="text-danger" v-if="!$v.model.email.required">
                Email is required
              </p>
              <p class="text-danger" v-if="!$v.model.email.email">
                Please enter valid email.
              </p>
               <p class="text-danger" v-if="alreadyRegisteredEmail">
          ...
          <div class="form-group">
            ...
            <div v-if="$v.model.password.$dirty || submitted">
              <p class="text-danger" v-if="!$v.model.password.required">
                Password is required
              </p>
              <p class="text-danger" v-if="!$v.model.password.minLength">
          ...
          <div class="form-group">
            ...
            <div v-if="$v.model.cnfpassword.$dirty || submitted">
              <p class="text-danger" v-if="!$v.model.cnfpassword.required">
